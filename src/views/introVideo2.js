...
import styles from './viewStyles/introVideo2.style';
    ...
    return (
      <LinearGradient colors={['#000000', '#131313', '#272727']} style={styles.container}>
        <View style={{ flex: 2, justifyContent: 'flex-end' }}>
          <Header headerText={'Navigating to Exercise'} />
        </View>
        <View style={{ flex: 4, justifyContent: 'center' }}>
          {this.state.hideVideo ?
            ...
            <VideoPlayer
              ...
              source={require('../../assets/videos/Tutorial_2_Final.mp4')}
            />
          }
          ...
          <View style={{ alignItems: 'center' }}>
            <SimpleButton
              onPress={() => {
                ...
                Analytics.screen('Intro Video 3');
                Actions.introVideo3({ reviewOnboarding: this.props.reviewOnboarding });
              }}
            >Next</SimpleButton>
          </View>
        </View>
...
Video2.defaultProps = defaultProps;

const mapStateToProps = state => ({ users: state.users });

export default connect(mapStateToProps, actions)(Video2);
