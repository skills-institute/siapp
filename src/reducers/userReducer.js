  ...
  switch (action.type) {
    ...
    case 'LOG_USER_IN': {
      ...
      return {
        ...
        stripeCustomer: action.payload.userInfo.my_stripe_customer,
        stripeCustomerEmail: action.payload.userInfo.my_stripe_customer_email,
        stripeCustomerId: action.payload.userInfo.my_stripe_customer_id,
